        ...
        <div class="mb-3 mt-4">
            ...
            @foreach ($technologies as $technology)
                <div class="form-check">
                    <input @checked(in_array($technology->id, old('technologies', []))) class="form-check-input" type="checkbox" name="technlogies[]" value="{{ $technology->id }}" id="technology-{{ $technology->id }}">
